#! /bin/bash
echo -e "\e[1;93m Startiong to Configure Ansible Managed Node Linux6-Node \e[0m\n"
...
echo 'NAME="eth1"' >> /home/pgrewal/net-cfg
echo 'DEVICE="eth1"' >> /home/pgrewal/net-cfg
echo 'ONBOOT="yes"' >> /home/pgrewal/net-cfg
echo 'IPADDR=192.168.56.203' >> /home/pgrewal/net-cfg
...
cp /home/pgrewal/net-cfg /etc/sysconfig/network-scripts/ifcfg-eth1
...
echo "+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-++-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-++-+-+" > /etc/motd
echo "+                WELCOME TO  ANSIBLE MANAGED NODE Linux6-NODE             +" >> /etc/motd
echo "+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-++-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-++-+-+" >> /etc/motd
