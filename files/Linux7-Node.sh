#! /bin/bash
echo -e "\e[1;93m Startiong to Configure Ansible Managed Node Linux7-Node \e[0m\n"
...
hostnamectl set-hostname Linux7-Node
...
echo 'IPADDR=192.168.56.202' >> /home/pgrewal/net-cfg
...
echo "+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-++-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-++-+-+" > /etc/motd
echo "+                WELCOME TO  ANSIBLE MANAGED NODE Linux7-NODE             +" >> /etc/motd
echo "+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-++-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-++-+-+" >> /etc/motd
